                    ...
                    <div class="mt-8">
                        ...
                        <div class="flex items-center flex-wrap gap-2 mt-8">
                            @if($vinyl->vinylSec && $vinyl->vinylSec->quantity > 0 && $vinyl->vinylSec->in_stock == 1)
                                ...
                                <h4 class="text-stone-800 text-2xl sm:text-3xl font-bold">R$ {{ number_format($vinyl->vinylSec->promotional_price ?? $vinyl->vinylSec->price, 2, ',', '.') }}</h4>
                                ...
                                @endif
                            @else
                            <h4 class="text-red-600 text-2xl sm:text-3xl font-bold">Indisponível</h4>
                            @endif
                        </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden h-full flex flex-col">
                    ...
                    <div class="p-4 flex-grow flex flex-col">
                        ...
                        <div class="mt-auto">
                            @if($relatedVinyl->vinylSec && $relatedVinyl->vinylSec->quantity > 0 && $relatedVinyl->vinylSec->in_stock == 1 && $relatedVinyl->vinylSec->price > 0)
                                ...
                                <p class="text-lg font-bold">R$ {{ number_format($relatedVinyl->vinylSec->promotional_price ?? $relatedVinyl->vinylSec->price, 2, ',', '.') }}</p>
                                @else
                                <p class="text-lg font-bold">R$ {{ number_format($relatedVinyl->vinylSec->price, 2, ',', '.') }}</p>
                                @endif
                            @else
                                <p class="text-red-600 font-bold">Indisponível</p>
                            @endif
                        </div>
                    </div>
                </div>
